...
for patience in [0, 1, 5]:
    crop = oflow.get_crop(frame_times, mag_means, threshold=5, padding_in=0, padding_out=0, patience=patience)
    print(f'Cropping found for patience={patience} and threshold=5: {crop}')
crop_other = oflow.get_crop(frame_times, mag_means, threshold=11, padding_in=0, padding_out=0, patience=0)
